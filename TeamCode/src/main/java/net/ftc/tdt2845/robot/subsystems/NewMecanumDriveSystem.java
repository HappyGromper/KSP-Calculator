...
public class NewMecanumDriveSystem {
     ...
     *        null
     */
    public NewMecanumDriveSystem(DcMotor leftFront, DcMotor leftRear, DcMotor rightFront, DcMotor rightRear, ModernRoboticsI2cGyro gyro) {
...
//        double rotated[] = rotateVector(xIn, yIn, gyro.getAngle());
        double rotated[] = rotateVector(xIn, yIn, gyro.getHeading());
        xIn = rotated[0];
        yIn = rotated[1];
